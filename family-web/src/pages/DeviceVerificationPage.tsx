  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      if (result.verified) {
        ...
        // Returning device -> OTP. First call to this number -> straight to lobby.
        navigate(session.deviceRegistered ? `/call/${linkToken}/otp` : `/call/${linkToken}/lobby`, { replace: true });
      } else {
